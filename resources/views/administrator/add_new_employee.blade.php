...
@section('container')   
    <div class="container-fluid">
        ...
        <form action="{{ route('save_employee_data') }}" method="POST" enctype="multipart/form-data">
            @csrf
            <div class="col-md-6">
                <div class="form-group">
                    <label for="first_name">First Name</label>
                    <input type="text" class="form-control @error('first_name') is-invalid @enderror" value="{{ old('first_name') }}" id="first_name" name="first_name">
                    @error('first_name')
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control @error('last_name') is-invalid @enderror" value="{{ old('last_name') }}" id="last_name" name="last_name">
                    @error('last_name')
                        <div class="invalid-feedback">{{ $message }}</div>
                    @enderror
                </div>
                <div class="form-group">
                    ...
                    <input type="date" class="form-control @error('date_of_birth') is-invalid @enderror" value="{{ old('date_of_birth') }}" id="date_of_birth" name="date_of_birth">
                    @error('date_of_birth')
                        <div class="invalid-feedback">{{ $message }}</div>
                    @enderror
                </div>
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control @error('email_address') is-invalid @enderror" value="{{ old('email_address') }}" id="email_address" name="email_address">
                    @error('email_address')
                        <div class="invalid-feedback">{{ $message }}</div>
                    @enderror
                </div>
                <div class="form-group">
                    ...
                    <select class="form-control @error('province_address') is-invalid @enderror" value="{{ old('province_address') }}" id="province_address" name="province_address" onchange="filterCity()">
                ...
                <div class="form-group">
                    ...
                    <select class="form-control @error('city_address') is-invalid @enderror" value="{{ old('city_address') }}" id="city_address" name="city_address">
                ...
                <div class="form-group">
                    ...
                    <textarea class="form-control @error('street_address') is-invalid @enderror" value="{{ old('street_address') }}" name="street_address" id="street_address" cols="20" rows="10"></textarea>
                ...
                <div class="form-group">
                    ...
                    <input type="number" class="form-control @error('zip_code') is-invalid @enderror" value="{{ old('zip_code') }}" id="zip_code" name="zip_code">
                    @error('zip_code')
                        <div class="invalid-feedback">{{ $message }}</div>
                    @enderror
                </div>
                <div class="form-group">
                    ...
                    <input type="number" class="form-control @error('ktp_number') is-invalid @enderror" value="{{ old('ktp_number') }}" id="ktp_number" name="ktp_number">
                    @error('ktp_number')
                        <div class="invalid-feedback">{{ $message }}</div>
                    @enderror
                </div>
                <div class="form-group">
                    <label for="ktp_image">KTP upload</label>
                    <input type="file" class="form-control-file @error('ktp_image') is-invalid @enderror" id="ktp_image" name="ktp_image">
                    @error('ktp_image')
                        <div class="invalid-feedback">{{ $message }}</div>
                    @enderror
                </div>
                <div class="form-group">
                    ...
                    <input type="text" class="form-control @error('current_position_bank_account') is-invalid @enderror" value="{{ old('current_position_bank_account') }}" id="current_position_bank_account" name="current_position_bank_account">
                    @error('current_position_bank_account')
                        <div class="invalid-feedback">{{ $message }}</div>
                    @enderror
                </div>
                <div class="form-group">
                    <label for="bank_account_number">Bank Account Number</label>
                    <select class="form-control @error('bank_account_number') is-invalid @enderror" value="{{ old('bank_account_number') }}" id="bank_account_number" name="bank_account_number">
                ...
                <div class="form-group">
                    ...
                    <select class="form-control @error('employee_position') is-invalid @enderror" value="{{ old('employee_position') }}" id="employee_position" name="employee_position">
